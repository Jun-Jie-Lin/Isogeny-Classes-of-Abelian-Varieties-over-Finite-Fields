...
for polyns in l:
    if polyns.is_irreducible():
        ...
        if vpa3 == 0:
            ...
            if vpa3 >= n/2 and vpa2 == 0 and n/2 not in rootvalus:
                prank2.append(polyns)
            
            elif vpa3 >= n and vpa2 >= n/2 and vpa1 == 0 and n/2 not in rootvalus:
                prank1.append(polyns)
                
            elif vpa3 == n and vpa2 >= 2/3 * n and vpa1 >= n/3 and len(rootvalus) == 0:
                prank0.append(polyns)
            
            elif vpa3 >= 3/2 * n and vpa2 >= n and vpa1 >= n/2 and len(rootvalus) == 0 and 3 not in factordegs:
                prank0.append(polyns)            
